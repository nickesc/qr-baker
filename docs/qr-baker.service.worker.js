...
/** @type {string} */
const CACHE_VERSION = '1745228123|111468449332';
/** @type {string} */
const CACHE_PREFIX = 'QR Baker-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'qr-baker.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["qr-baker.html","qr-baker.js","qr-baker.offline.html","qr-baker.icon.png","qr-baker.apple-touch-icon.png","qr-baker.audio.worklet.js","qr-baker.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["qr-baker.wasm","qr-baker.pck"];
