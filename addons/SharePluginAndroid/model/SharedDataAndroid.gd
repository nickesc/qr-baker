...
func set_title(a_title: String) -> SharedDataAndroid:
	_data[DATA_KEY_TITLE] = a_title
	return self


func set_subject(a_subject: String) -> SharedDataAndroid:
	_data[DATA_KEY_SUBJECT] = a_subject
	return self


func set_content(a_content: String) -> SharedDataAndroid:
	_data[DATA_KEY_CONTENT] = a_content
	return self


func set_file_path(a_file_path: String) -> SharedDataAndroid:
	_data[DATA_KEY_FILE_PATH] = a_file_path
	return self


func set_mime_type(a_mime_type: String) -> SharedDataAndroid:
